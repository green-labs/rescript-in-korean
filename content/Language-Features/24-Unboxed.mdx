...
자바스크립트 출력을 보면, 학생 이름 또는 인사가 자바스크립트 객체에 포함된 것을 볼 수 있습니다. (자세한 내용은 [variant JS output](variant#javascript-output)과 [record JS output](record#javascript-output)를 참고하세요)
