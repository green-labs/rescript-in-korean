...
즉, 함수 타입을 작성하는지, 인자 타입 어노테이션을 작성하는지에따라 타입 시그니쳐가 다릅니다.
...
그러나 리스크립트는 지능적으로 [꼬리 재귀](https://stackoverflow.com/questions/33923/what-is-tail-recursion)을 사용해 빠른 JavaScript 루프로 컴파일합니다.
...
**이 기능은 사소 해 보이지만** 실제로는 함수형 언어에서 가장 중요한 기능 중 하나입니다.
