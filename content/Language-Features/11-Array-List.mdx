...
표준 라이브러리는 [List module](api/belt/list)를 제공합니다..

#### 불변하는 머리 항목? (Immutable Prepend)
...
`switch` ([pattern matching section](pattern-matching-destructuring.md)) 참고)는 보통 리스트의 항목에 접근하기 위해 사용됩니다.
