...
title: "개요"
metaTitle: "언어 특징 개요"
description: "리스트립트의 문법 개요 빠르게 훑어보기"
sourceUrl: "https://rescript-lang.org/docs/manual/latest/overview"
canonical: "/rescript-in-korean/overview"
---
...
| `a == b`                                              | 명시적인 캐스팅을 수반한 동일성 없음 (감사하게도)     |
...
\* 컴파일러에서 `data` 의 길이가 2가 아닐 수도 있다는 워닝(warning)을 제공한다.
...
마지막으로 `{}`로 경계가 나뉘어진 블록 표현은 명시적으로 리턴을 합니다. 자바스크립트에서는 즉시 실행 함수를 통해서 시뮬레이션해볼 수 있습니다. (함수 바디에 각각의 로컬 스코프를 가지고 있기 때문)
